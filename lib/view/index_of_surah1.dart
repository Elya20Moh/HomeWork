...
import 'package:practice/pages/naba.dart';
import 'package:practice/pages/Iklas.dart';

class listOfSurah1 extends StatelessWidget {
  const listOfSurah1({Key? key}) : super(key: key);
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const alIkhlas(),
                                    ),
                                  );
                                },
                                child: Text(
